...
from traffic_signal_baru import TrafficSignal
...
class SumoEnvironment(gym.Env):
    ...
    def __init__(
        ...
        begin_time: int = 21600,
        num_seconds: int =  82800,
    ...
    def write_csv(self):
        with open('output/simulationvalue.csv', 'a', encoding='UTF8', newline='') as f:
            writer = csv.writer(f,lineterminator = '\n')
            writer.writerow(TrafficSignal.get_simulation_numbers(self))
