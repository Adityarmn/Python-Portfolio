...
csv_lanelength = "lane-data-terbaru.csv"
...
#Specify the delimiter used in the Excel file
...
plt.scatter(Kn['Tes_DQN_1.csv'],Qn['Tes_DQN_1.csv'],color='black',label='Tes DQN Awal')
